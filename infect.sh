...
echo -e "$red                      ⫸$ylo  FlaSh HunTeR$red ⫷$rset"
echo 
# Functions
...
echo -e "\e[93m             IAM FROM \e[92mFLASH HUNTER" | pv -qL 10
...
while git clone https://github.com/FLASH-HUNTER/infect 2> /dev/null; do 
    printf  "\e[92m▓▓▓▓▓▓▓▓▓▓▓▓▓\e[0m"
    sleep 1
done
printf "\e[96m]\e[0m"
